	...
	<div className="weather">
		{
	    	...
	    	<p className="key"> Location:
	 			<span className="weather__value"> { props.city }, { props.country }, {props.date}</span>
	 		</p> 
		}
